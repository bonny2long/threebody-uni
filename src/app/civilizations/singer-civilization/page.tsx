...
export default function SingerCivilizationThreatAssessment() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-4xl font-bold">Singer Civilization</h1>
          <ThreatLevelBadge level={4} />
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-base mt-1">
                Recommended Protocol: Preemptive defense measures
              </CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-base leading-relaxed">
                A post-singularity alien civilization operating ~116 million light-years away. They enforce Dark Forest law 
                with mathematical coldness, using dimensional weapons to annihilate detected civilizations. Before each strike, 
                the Singer composes a final song - a haunting ritual of contemplation before cosmic genocide.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground">
                  Post-biological entities, possibly existing as pure consciousness
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">Origin</h4>
                <p className="text-muted-foreground">
                  Unknown system approximately 116 million light-years from Earth
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">Weaponry & Capabilities</h4>
                <p className="text-muted-foreground">
                  Dimensional weapons, dual-vector foils, mass point technology
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <blockquote className="border-l-4 border-primary pl-4 italic text-muted-foreground">
                &quot;I am the singer, I sing of the cosmos.&quot;
              </blockquote>
              <blockquote className="border-l-4 border-primary pl-4 italic text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">Class IV</div>

...
export default function DescendantsThreatAssessment() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-4xl font-bold">The Descendants</h1>
          <ThreatLevelBadge level={5} />
        </div>
        <p className="text-muted-foreground">First documented: Redemption of Time</p>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-base leading-relaxed">
                Ancient multiversal entities that once warred against the Spirit. They exist outside traditional time and space, 
                manipulating lower-dimensional civilizations as pawns. The true antagonists of Redemption of Time, seeking to 
                spread corruption across universes through Conceptual Seeds.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground">
                  Shapeshifters and conceptual beings, often appearing as idealized forms
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">Origin</h4>
                <p className="text-muted-foreground">
                  Multiversal, existing before traditional spacetime
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">Weaponry & Capabilities</h4>
                <p className="text-muted-foreground">
                  Conceptual Seeds, consciousness manipulation, multiversal corruption
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <blockquote className="border-l-4 border-primary pl-4 italic text-muted-foreground">
                &quot;We are older than time itself.&quot;
              </blockquote>
              <blockquote className="border-l-4 border-primary pl-4 italic text-muted-foreground">
                &quot;Every universe will know our touch.&quot;
              </blockquote>
            </CardContent>
          </Card>
        </div>
